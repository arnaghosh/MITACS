...
class Main(QtGui.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.add_str = ("insert into subjectdata (subNo,subName,age,gender,nativeTongue,hand,occupation,tdcsNo,leisureFreq,week,dayTime) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)");
