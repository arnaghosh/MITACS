...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.trials.setGeometry(QtCore.QRect(81, 459, 39, 16))
        ...
        self.label.setGeometry(QtCore.QRect(640, 459, 39, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.combo_block = QtGui.QComboBox(self.centralwidget)
        self.combo_block.setGeometry(QtCore.QRect(695, 459, 238, 22))
        ...
        self.combo_holdTime.addItem(_fromUtf8(""))
        self.combo_holdTime.addItem(_fromUtf8(""))
        self.restState = QtGui.QPushButton(self.centralwidget)
        self.restState.setGeometry(QtCore.QRect(460, 650, 131, 41))
        self.restState.setObjectName(_fromUtf8("restState"))
        self.restLabel = QtGui.QLabel(self.centralwidget)
        self.restLabel.setGeometry(QtCore.QRect(110, 230, 211, 31))
        self.restLabel.setObjectName(_fromUtf8("restLabel"))
        self.restTime = QtGui.QLabel(self.centralwidget)
        self.restTime.setGeometry(QtCore.QRect(250, 270, 261, 31))
        self.restTime.setObjectName(_fromUtf8("restTime"))
        self.text_restTime = QtGui.QLineEdit(self.centralwidget)
        self.text_restTime.setGeometry(QtCore.QRect(530, 269, 61, 31))
        self.text_restTime.setObjectName(_fromUtf8("text_restTime"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.combo_holdTime.setItemText(0, _translate("MainWindow", "pre-exercise", None))
        self.combo_holdTime.setItemText(1, _translate("MainWindow", "30", None))
        self.combo_holdTime.setItemText(2, _translate("MainWindow", "60", None))
        self.combo_holdTime.setItemText(3, _translate("MainWindow", "90", None))
        self.combo_holdTime.setItemText(4, _translate("MainWindow", "120", None))
        self.restState.setText(_translate("MainWindow", "Resting State", None))
        self.restLabel.setText(_translate("MainWindow", "Resting State Parameters :", None))
        self.restTime.setText(_translate("MainWindow", "Resting State Time (in seconds)", None))
        self.text_restTime.setText(_translate("MainWindow", "360", None))
